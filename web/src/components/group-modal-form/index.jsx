...
import { filterObj } from "src/library/utils";
import "./index.less";
...
export default ({
    ...
    const handleExpand = () => {
        ...
        handleOnExpand && handleOnExpand(!isExpand);
    };
        ...
        >
            ...
            >
                {options.map((oitem, oindex) => {
                    return (
                        <div styleName="group-box" title={oitem.label} key={oindex}>
                            <div styleName="group-box-inner">
                                {oitem.children.map((item, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <Tree
                                                    ...
                                                    onCheck={(keys, info) =>
                                                        onTreeCheck(keys, info, item.name)
                                                    }
                                                />
                                            </Form.Item>
                                        );
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <If data={item.includeClear}>
                                                        <Button onClick={()=>handleUploadClear(item.name)} style={{marginLeft:8}}>清除</Button>
                                                    </If>
                                                </div>
                                                <If
                                                    data={
                                    ...
                                    if (item.type == "multipleUpload") {
                                        return (
                                            ...
                                            >
                                                ...
                                                >
                                                    {fileList.length >= 8 || item.disabled
                                                        ? null
                                                        : uploadButton}
                                                </Upload>
                                            </Form.Item>
